...
<body>
  ...
  <section id="home">
          ...
          <div class="container-fluid">
                <a class="navbar-brand" href="Taqy_home.php"><img src="https://hmsitel-u.id/wp-content/uploads/2021/01/logo-ead-1.png" class="w-100" alt="" style="height:2rem;width:50%"></a>
...
<footer class="bg-light py-2 text-center">
  ...
  <p class="text-secondary m-0">Attaqy_1202194314</p></footer>
